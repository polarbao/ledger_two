...
description: Use for LedgerTwo architecture boundary decisions, module responsibility checks, dependency direction, public API changes, and ADR creation.
---

# LedgerTwo Architecture Guardrails
...
5. Relevant formal PRD/DEV/DOC files under `docs`
...
- For long-lived or irreversible choices, create or update an ADR/DOC_DECISION under `docs`.
