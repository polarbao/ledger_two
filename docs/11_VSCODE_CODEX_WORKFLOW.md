...
1. 先让 Codex 阅读 `docs/01_PRD.md`、`docs/03_TECH_DESIGN.md`、`docs/07_DATABASE_API.md`、`AGENTS.md`。
2. 一次只让 Codex 实现一个模块。
...
```text
请阅读 docs/01_PRD.md、docs/03_TECH_DESIGN.md、docs/07_DATABASE_API.md 和 AGENTS.md。
