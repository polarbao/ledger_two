...
- docs/tech/09-测试与质量保障.md
- docs/reviews/2026-06-11-产品与技术文档评审.md
...
- docs/tech/02-后端模块设计.md
- docs/tech/04-数据库与API设计.md
- docs/ui/09-空状态加载态与错误态.md
...
```text
请先阅读：
- docs/tech/11-认证安全与权限设计.md
- docs/prd/01-账本成员与权限.md
- docs/prd/02-账单系统.md
- docs/tech/10-统一错误码与异常处理.md
...
- docs/tech/11-认证安全与权限设计.md
- docs/prd/02-账单系统.md
- docs/prd/03-共同支出分摊与结算.md
- docs/ui/11-数据安全与高风险操作确认.md
...
```text
请先阅读：
- docs/prd/06-导入导出与规则自动化.md
- docs/tech/06-导入导出与备份恢复.md
...
```text
请先阅读：
- docs/tech/05-分摊与结算算法.md
- docs/prd/03-共同支出分摊与结算.md
- docs/tech/12-统计口径与报表计算规则.md
- docs/tech/09-测试与质量保障.md
...
请先阅读：
- docs/prd/02-账单系统.md
- docs/ui/03-流水列表筛选与详情.md
- docs/ui/04-记账与账单表单.md
- docs/tech/03-前端模块设计.md
...
```text
请先阅读：
- docs/prd/09-跨端PWA与同步策略.md
- docs/tech/07-跨端技术方案.md
- docs/ui/08-移动端与PWA交互.md
...
- repository 处理数据库访问
- 统一错误响应结构
- 错误码使用 docs/tech/10-统一错误码与异常处理.md
- 权限规则必须测试
- 结算和统计不得在前端实现最终计算
```
...
- 金额输入元，API 提交分
- 遵守 docs/ui/10-设计系统与组件规范.md
- 所有页面覆盖 loading / empty / error 状态
- 危险操作遵守 docs/ui/11-数据安全与高风险操作确认.md
- 移动端优先，桌面端增强
```
