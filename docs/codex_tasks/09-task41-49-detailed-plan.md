...
状态：主体已落地；导入工作台已加入规则管理面板，支持创建、编辑、归档、恢复、active/archived/all 筛选和多标签推荐选择，预览行已展示规则命中解释与推荐分类/账户/标签名称；规则列表已补充归档或不可用元数据提示。Figma 390px 设计稿与截图验收已补齐，真实前端 375px/390px 浏览器验收仍需继续收口。
