...
- 规则命中前端状态测试。
- 归档规则和归档元数据回归验收。
- Figma handoff checklist 同步更新，补充 `docs/ui/figma/v1.2-task49-import-rule-manager-handoff.md`；当前账户主文件为 `https://www.figma.com/design/Q4m7LRw75qrkFdw4O5xmU0`，原文件 `https://www.figma.com/design/wkU5RRZs5R7McjNUlEaFF2` 保留为历史参考。
...
Task49X 例外说明：2026-07-14 已按真实导出格式纠正为仅新增微信 XLSX；支付宝和通用模板保持 CSV。其范围不得借机扩展到支付宝 XLSX、xls/xlsm、通用 Excel 映射、银行同步或自动提交；详细任务以 `docs/codex_tasks/12-v1.2-xlsx-import-special-plan.md` 为准。
