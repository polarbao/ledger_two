...
Task49X 例外说明：2026-07-12 已批准微信、支付宝 XLSX 作为 v1.2 RC 专项。其范围不得借机扩展到 xls/xlsm、通用 Excel 映射、银行同步或自动提交；详细任务以 `docs/codex_tasks/12-v1.2-xlsx-import-special-plan.md` 为准。
