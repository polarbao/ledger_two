...
- 规则命中前端状态测试。
- 归档规则和归档元数据回归验收。
- Figma handoff checklist 同步更新，补充 `docs/ui/figma/v1.2-task49-import-rule-manager-handoff.md`，并生成线上 Figma 文件 `https://www.figma.com/design/wkU5RRZs5R7McjNUlEaFF2`。
