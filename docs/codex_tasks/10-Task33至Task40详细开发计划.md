...
1. `docs/00-文档索引.md`
2. `docs/prd/11-v1.1前基础框架补齐.md`
3. 对应 Tech/UI 文档
4. 本文对应任务章节
5. 如涉及业务口径，读取 `docs/prd/27-v1.1至v1.2验收样例矩阵.md` 与 `docs/prd/28-交易与账户口径补充.md`
...
- `docs/prd/27-v1.1至v1.2验收样例矩阵.md` 的 M01、M02、M03。
...
- 对应 `docs/prd/27-v1.1至v1.2验收样例矩阵.md` 的 R01、R02。
...
- `docs/prd/27-v1.1至v1.2验收样例矩阵.md` 的 R03。
