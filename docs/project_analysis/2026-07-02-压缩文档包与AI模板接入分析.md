...
- `docs/LedgerTwo-基础文档包-2026-06-17.zip`
- `docs/LedgerTwo-AI就绪上传包-v0.3.zip`
- `docs/LedgerTwo-本地上传包.zip`
- `ai-project-template/`
...
### 2.2 LedgerTwo-AI就绪上传包-v0.3.zip
...
### 2.3 LedgerTwo-基础文档包-2026-06-17.zip
...
- 总体文档：`docs/00-文档索引.md`、`docs/README.md`
- 原始主文档：`docs/01-产品需求文档.md` 到 `docs/18-演示后AI编码任务与提示词.md`
- 模块化 PRD：`docs/prd/*`
- 模块化技术文档：`docs/tech/*`
- 模块化 UI 文档：`docs/ui/*`
- 审阅报告：`docs/reviews/*`
...
3. 后续开发前应优先执行 `docs/codex_tasks/05-Foundation任务计划.md` 中的 Task31：文档事实源收口。

判断：

- 可以支持后续开发。
- 不建议继续只依赖早期 `17-AI编码任务与提示词.md`。
...
- 正式文档入口：`docs`
- 当前任务入口：`docs/codex_tasks/05-Foundation任务计划.md`
