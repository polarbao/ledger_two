...
| 任务 | 状态 | 证据 |
|---|---|---|
| Task31 文档事实源收口 | 基本完成 | `docs/00-文档索引.md`、`docs/README.md`、`docs/codex_tasks/` 已成为入口 |
...
| Task34 API 契约与 OpenAPI | 基本完成 | `docs/api/API清单.md`、`API规范.md`、`openapi.yaml` |
...
| 旧 NAS 文档冲突 | 旧 `docs/06-NAS部署.md` 应标记为历史文档 |
...
详细 v1.1 收口验证记录见 `docs/project_analysis/2026-07-07-v1.1收口验证.md`。
