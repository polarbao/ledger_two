...
实施更新（2026-07-12）：微信 XLSX 已在本机 `Ubuntu-24.04` WSL staging 创建 ready 预览批次，识别 276 行（275 new、1 suspicious、0 invalid），`transactions` 前后均为 40。NAS 未访问。最新证据以 `docs/project_analysis/2026-07-12-本机WSL真实账单预览验收.md` 为准。
