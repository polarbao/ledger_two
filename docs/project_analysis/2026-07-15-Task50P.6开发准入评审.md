...
| development/staging/production 物理隔离 | `docs/tech/23-v1.2部署环境与数据库隔离.md` 已冻结实例、目录和 channel 规则 | 通过，开发时持续检查 |
...
1. `docs/prd/31-v1.3-Task50多账本正式化.md`
2. `docs/tech/25-v1.3-Task50多账本实施契约.md`
3. `docs/api/openapi-v1.3-ledger-draft.yaml`
4. `docs/prd/32-v1.3-Task50验收样例矩阵.md`
5. `docs/ui/16-v1.3-Task50多账本交互流程.md`
6. `docs/ui/figma/task50-v1.3-multi-ledger/`
7. `docs/codex_tasks/15-v1.3-Task50多账本详细实施计划.md`
...
Task50P.6 以“仅独立 development”条件关闭。下一任务是 `Task50.1`，执行入口为 `docs/codex_tasks/15-v1.3-Task50多账本详细实施计划.md`。在 Task50.1 提交并通过 migration/model/repository 门禁前，Task50.2-Task50.6 保持未开始。
