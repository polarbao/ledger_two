...
任务：`docs/codex_tasks/13-fresh-light-ui-interaction-plan.md` / UI-FL-03
...
UI-FL-04 先冻结记账抽屉的字段分组、Footer、移动 Bottom Sheet 和提交状态契约；UI-FL-05 在该入口契约稳定后迁移流水工作台。Task49X 的支付宝真实 XLSX、NAS staging schema 19 和发布门禁继续独立收口，不混入 UI-FL 页面提交。
