...
1. 当前环境与数据保全：本文。
2. 一次性清库换代：`../codex_tasks/20-nas-release-data-lifecycle-plan.md`。
3. Task53 staging 证据：`../project_analysis/2026-07-20-task53-nas-staging-deployment.md`。
4. 发布升级与回滚：`../releases/v1.3.0-rc-upgrade-guide.md`。
