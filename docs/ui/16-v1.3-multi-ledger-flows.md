...
UI-FL-10 只负责全局可访问性、主题、响应式和缺陷收口，不提前创建上述 Task50 组件。Task50 开发开始时必须基于 UI-FL-10 完成提交，不反向修改已关闭 UI-FL 业务页面。
...
P.5 完成仍不允许编码；只有 UI-FL-10 完成且 Task50P.6 关闭后，才能启动 Task50.1。
