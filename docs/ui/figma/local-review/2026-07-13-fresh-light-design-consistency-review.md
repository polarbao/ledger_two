...
状态：已审阅并本地化  
审阅范围：`docs/ui/figma/`、`docs/ui/lynntest(1).html`、最新 PRD/技术/UI 文档、关键 React 页面  
新设计本地事实源：`../ledger-two-fresh-light-implementation-spec-2026-07-13.md`
...
- 已经把 `lynntest(1).html` 定义为浅色财务方向的来源。
...
| `ledger-two-design-system-brief.md` | 部分一致 | 是 | Fresh Light 语言一致，但阶段判断仍偏“仅导入试点/未来探索” |
...
| `component-library.md` | 一致 | 否 | 组件原则、高风险确认、移动卡片/桌面表格和 React 映射与新版一致 |
| `v1.1-v1.2-ui-draft-spec.md` | 部分一致 | 是 | 原有版本稿合理，但需要追加 Fresh Light 全应用目标设计章节 |
| `handoff-checklist.md` | 一致 | 否 | Token、状态、移动/桌面尺寸和验收证据要求仍适用 |
...
docs/ui/figma/local-review/2026-07-13-fresh-light-design-consistency-review.md
```
...
1. `ledger-two-fresh-light-implementation-spec-2026-07-13.md`。
